...
class DatabaseMigrationTests(unittest.TestCase):
    def test_all_schema_components_are_applied_and_recorded(self):
        ...
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_learning_sessions", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_learning_questions", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_learning_attempts", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_learning_sources", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_learning_reviews", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_learning_review_attempts", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_learning_knowledge_candidates", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_ontology_concepts", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_ontology_concept_sources", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_ontology_aliases", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_ontology_relations", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_document_concepts", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_ontology_shadow_events", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_ontology_relation_evidence", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_baseline_drafts", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_baseline_releases", sql)
        self.assertIn("CREATE TABLE IF NOT EXISTS knowledge_baseline_documents", sql)
        ...
        self.assertIn("DROP COLUMN IF EXISTS openai_oauth_access_token_encrypted", sql)
