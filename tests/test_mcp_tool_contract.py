...
EXPECTED_TOOLS = {
    ...
    "plan_learning_feedback": ["assessment", "confidence", "missing_concepts", "misconceptions", "evidence_refs", "hint", "next_question"],
    ...
    "record_learning_attempt": ["session_id", "question_id", "answer", "assessment", "confidence", "feedback_plan", "missing_concepts", "misconceptions", "evidence_refs", "next_question", "next_question_type", "next_evidence_refs", "client_request_id"],
    "resume_learning_session": ["session_id"], "complete_learning_session": ["session_id", "summary"],
