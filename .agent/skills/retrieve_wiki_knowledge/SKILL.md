...
* **Entrypoint**: `src.agent_tool:retrieve_wiki_knowledge`
* **Runtime**: `.venv/bin/python`

## 3. Reference CLI (테스트 명령어)

```bash
.venv/bin/python -c "from src.agent_tool import retrieve_wiki_knowledge; print(retrieve_wiki_knowledge('Graph RAG', limit=1))"
```
